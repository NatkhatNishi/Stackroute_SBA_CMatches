...
public class SwaggerConfig {
	...
	public Docket getAPIDocker() {
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.stackroute.matchrecommendationservice.controller"))
	...
	private ApiInfo apiMetaInfo() {
		return new ApiInfo("CMatch application RESTful APIs", "Cmatches application RESTful APIs description", "1.0", 
